...
- (void)viewDidLoad {
    ...
    self.tabBar.layer.shadowOffset = CGSizeMake(0, 10);  // 设置阴影的偏移量
    self.tabBar.layer.shadowRadius = 20.0;  // 设置阴影的半径
    self.tabBar.layer.shadowColor = [UIColor yellowColor].CGColor; // 设置阴影的颜色为黑色
    self.tabBar.layer.shadowOpacity = 0.9; // 设置阴影的不透明度
