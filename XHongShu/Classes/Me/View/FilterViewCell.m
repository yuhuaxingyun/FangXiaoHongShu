...
- (void)setMuDict:(NSMutableDictionary *)muDict{
    _muDict = muDict;
    self.imageView.image = [Auxiliary changeImage:[[[_muDict allKeys] lastObject] intValue] imageView:[[_muDict allValues] lastObject]];
}
@end
