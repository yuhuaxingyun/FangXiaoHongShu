...
- (void)createFilterView{
    ...
    _filterGalleryView = [[EditPotoCollectionView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(_filterBtn1.frame)+10, VIEW_WEDTH,filterView.bounds.size.height -30)];
    ...
    _beautifyPhotosView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(_filterBtn1.frame), VIEW_WEDTH,filterView.bounds.size.height -30)];
